...
type Statement struct {
	...
	Variables     []string `json:"variables,omitempty"`      // List of declared variables
	Uses          []string `json:"uses,omitempty"`           // List of variable uses
	Block         Block    `json:"block,omitempty"`          // Nested block
	Calls         []string `json:"calls,omitempty"`          // List of function calls
